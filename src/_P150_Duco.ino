//#######################################################################################################
//############################## Plugin 150: Itho ventilation unit 868Mhz remote ########################
//#######################################################################################################
...
void PLUGIN_150_ITHOinterrupt() ICACHE_RAM_ATTR;

// extra for interrupt handling
Ticker PLUGIN_150_ITHOticker;
	...
	case PLUGIN_INIT:
		{
			...
			addLog(LOG_LEVEL_INFO, F("CC1101 868Mhz transmitter initialized"));
						attachInterrupt(Plugin_150_IRQ_pin, PLUGIN_150_ITHOinterrupt, RISING);
...
void PLUGIN_150_ITHOinterrupt()
{
	PLUGIN_150_ITHOticker.once_ms(1, PLUGIN_150_ITHOcheck);	
}

void PLUGIN_150_ITHOcheck()
{
	noInterrupts();
